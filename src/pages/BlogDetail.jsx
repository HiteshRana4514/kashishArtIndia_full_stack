...
import { FaFacebook, FaTwitter, FaLinkedin, FaArrowLeft, FaLink, FaCheck } from 'react-icons/fa';
              ...
              <article className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="mt-10 mx-auto max-w-4xl px-4 sm:px-0">
                  <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8 prose prose-lg max-w-none">
                    {blog.content ? (
                      <div 
                        className="prose prose-headings:text-kashish-blue prose-a:text-blue-600 prose-img:rounded-lg prose-img:shadow-md blog-content"
                  ...
                  <div className="border-t pt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      {relatedPosts.map((relatedBlog) => (
                        <div key={relatedBlog._id} className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300">
                          <Link to={`/blog/${relatedBlog.slug}`} className="block h-full group">
                            {relatedBlog.coverImage ? (
                              ...
                              <div className="relative w-full aspect-video bg-gradient-to-r from-kashish-blue to-blue-600 flex items-center justify-center rounded-t-xl">
