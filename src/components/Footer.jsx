        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <img
                ...
                className="w-[120px] h-[60px] object-contain rounded-lg shadow bg-white p-1"
              />
              <span className="text-xl font-bold">Kashish Art India</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Bringing the beauty of Indian art to your home. Discover unique
              paintings that tell stories and capture emotions.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <a href="mailto:info@kashishartindia.com">Email: info@kashishartindia.com</a>
              <p>Phone: +91 9835117590</p>
              <p>
                Address: G 101 Rajhans Residency, Sector 1, Greater Noida (W),
                201306, India
              </p>
            </div>
          </div>
