        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <img
                ...
                className="w-8 h-8 object-contain rounded-lg shadow"
              />
              <span className="text-xl font-bold">Kashish Art India</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Bringing the beauty of Indian art to your home. Discover unique paintings that tell stories and capture emotions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/products" className="text-gray-300 hover:text-white transition-colors">Paintings</a></li>
